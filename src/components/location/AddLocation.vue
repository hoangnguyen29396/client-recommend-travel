    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="body">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-lg-6">
                ...
                <br>
                <select class="form-control" v-model="selected" @change="handlePlaceTypeChange">
                  <option disabled>Choose place type</option>
          ...
          <br>
          <button @click="createLocation(location)" type="submit" class="btn btn-primary">Add</button>
        </div>
      </div>
    </div>
  </div>
